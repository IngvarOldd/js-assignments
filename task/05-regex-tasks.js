...
function getRegexForGuid() {
   return /\{[0-9A-F][0-9A-F][0-9A-F][0-9A-F][0-9A-F][0-9A-F][0-9A-F][0-9A-F]-[0-9A-F][0-9A-F][0-9A-F][0-9A-F]-[0-9A-F][0-9A-F][0-9A-F][0-9A-F]-[0-9A-F][0-9A-F][0-9A-F][0-9A-F]-[0-9A-F][0-9A-F][0-9A-F][0-9A-F][0-9A-F][0-9A-F][0-9A-F][0-9A-F][0-9A-F][0-9A-F][0-9A-F][0-9A-F]\}/i;
}
...
function getPasswordValidator(minLength) {
   return new RegExp('^(?=[^_ ]*[a-z])(?=[^_ ]*[A-Z])(?=[^_ ]*[0-9])(?=.{' + minLength + ',})');
}
